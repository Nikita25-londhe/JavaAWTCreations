...
public class Subtraction extends javax.swing.JFrame
{
    ...
    public static void addsubFrame(JFrame t)
    {
        Subtraction s=new Subtraction();
        s.setVisible(true);
        s.setLocationRelativeTo(t);
        t.dispose();
    }
    ...
    {//GEN-HEADEREND:event_button1ActionPerformed
        ...
        {
            CommonalertBox.showMsg("Input Field should not be empty",this);
            txt1.setText("");
            txt2.setText("");
        }
        else
