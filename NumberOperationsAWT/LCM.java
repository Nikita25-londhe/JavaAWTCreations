...
public class LCM extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        lblans.addComponentListener(new java.awt.event.ComponentAdapter()
        {
            public void componentHidden(java.awt.event.ComponentEvent evt)
            {
                lblansComponentHidden(evt);
            }
        });
    ...
    {//GEN-HEADEREND:event_btnsubmitActionPerformed
        ...
        {
            int ans=calcLcm(Integer.parseInt(txt1.getText()),Integer.parseInt(txt2.getText()));
            lblans.setText("LCM = "+String.valueOf(ans));
            try
            {
                Thread.sleep(3000);
            }
    ...
    private void lblansComponentHidden(java.awt.event.ComponentEvent evt)//GEN-FIRST:event_lblansComponentHidden
    {//GEN-HEADEREND:event_lblansComponentHidden
        // TODO add your handling code here:
    }//GEN-LAST:event_lblansComponentHidden
